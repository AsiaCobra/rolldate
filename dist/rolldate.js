...
(function (global, factory) {
  ...
  Rolldate.prototype = {
    ...
    createUI: function createUI() {
      ...
      var startDateStr = $(config.el).getAttribute('data-start'),
      ...
      for (var i = 0; i < len; i++) {
        ...
        if (f == 'YYYY') {
          for (var j = startDate.getFullYear(); j <= endDate.getFullYear(); j++) {
          ...
          var startMonth = startDate.getFullYear() == date.getFullYear() ? startDate.getMonth() + 1 : 1;
          var endMonth = endDate.getFullYear() == date.getFullYear() ? endDate.getMonth() + 1 : 12;
          ...
          var startDay = startDate.getFullYear() == date.getFullYear() && startDate.getMonth() == date.getMonth() ? startDate.getDate() : 1;
          var endDay = endDate.getFullYear() == date.getFullYear() && endDate.getMonth() == date.getMonth() ? endDate.getDate() : _this.getMonthlyDay(date.getFullYear(), date.getMonth() + 1);
          for (var l = startDay; l <= endDay; l++) {
          ...
          var startHour = startDate.getFullYear() == date.getFullYear() && startDate.getMonth() == date.getMonth() && startDate.getDate() == date.getDate() ? startDate.getHours() : 0;
          var endHour = endDate.getFullYear() == date.getFullYear() && endDate.getMonth() == date.getMonth() && endDate.getDate() == date.getDate() ? endDate.getHours() : 23;
          ...
          var startSecond = startDate.getFullYear() == date.getFullYear() && startDate.getMonth() == date.getMonth() && startDate.getDate() == date.getDate() && startDate.getHours() == date.getHours() && startDate.getMinutes() == date.getMinutes() ? startDate.getSeconds() : 0;
          var endSecond = endDate.getFullYear() == date.getFullYear() && endDate.getMonth() == date.getMonth() && endDate.getDate() == date.getDate() && endDate.getHours() == date.getHours() && endDate.getMinutes() == date.getMinutes() ? endDate.getSeconds() : 59;
          for (var o = startSecond; o <= endSecond; o++) {
      ...
      var _loop = function _loop(_i) {
        ...
        that.on('scrollEnd', function () {
          ...
          if ([domId['YYYY'], domId['MM']].indexOf(that.wrapper.id) != -1 && _this.scroll['YYYY'] && _this.scroll['MM'] && _this.scroll['DD']) {
            var day = _this.getMonthlyDay(_this.getSelected(_this.scroll['YYYY']), _this.getSelected(_this.scroll['MM'])),
                li = '';

            if (day != $('#' + domId['DD'] + ' li', 1).length) {

              for (var _l = 1; _l <= day; _l++) {
